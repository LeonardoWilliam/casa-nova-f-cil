...
import { getProfile, FinancialProfile, formatCurrency, resetProfile, formatTempoRestante, getMesesParaEntrada } from "@/lib/financial-store";
import { ArrowLeft, User, DollarSign, Home, Clock, RotateCcw, Edit } from "lucide-react";
...
export default function Profile() {
  ...
  const items = [
    { icon: User, label: "Nome", value: profile.nome || "Não informado" },
    ...
    <div className="min-h-screen bg-background pb-24">
      ...
      <div className="max-w-md mx-auto px-4 -mt-4 space-y-4">
        ...
        <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }}
          ...
          <p className="text-sm text-muted-foreground">Rumo à casa própria 🏠</p>
        </motion.div>
